...
$(function() {
    ...
    /*=========================================================================
     ...
     $(document).ready(function() {
        // Scroll the page slightly down on load
        window.scrollBy(0, 70); // Adjust the second parameter to control the amount of scroll
        ...
        // Click event handler for vertical menu links
